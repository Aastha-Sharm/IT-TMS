...
interface AssetTicketDetailsProps {
  id: number;
  title: string;
  description: string;
  created_by: string;
...
const AssetTicketDetails: React.FC<AssetTicketDetailsProps> = ({
  id,
  title,
  description,
  created_by,
    ...
    <div className="bg-white p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-6 gap-x-8 text-sm">
        ...
        <div>
          ...
          <p className="text-black">Asset</p> {/* ✅ Fixed as Asset */}
        </div>
      ...
      <div className="flex justify-end mt-10 pt-6">
        <button
          onClick={() =>
            onUpdate({ status: ticketStatus, response: ticketResponse })
          }
